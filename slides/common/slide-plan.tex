...
\newcommand{\introKey}{concurrency, parallelism, agents, threads, scheduler, affinity, multiplexing, race condition, deadlock, Amdahl's law}
...
\newcommand{\syncPrimitivesKey}{monitor, barrier, latch, thundering herd, latency, read-write lock, semaphore, thread pools, load balancing,}
